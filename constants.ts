    ...
    events: [
      {
        ...
        location: '湯之杜 志戶平',
        activity: '出發',
        notes: '南下前往銀山，約2.5~3小時車程',
        importantNotes: '🚗 志戶平→銀山路線：走「東北橫斷自動車道/秋田自動車道」→「横手IC」→「國道13號南下」→「縣道188號」。導航經由點設「横手IC」。⛽ 出發前在花巻加滿油，山形側加油站少。🌨️ 前一晚確認横手、尾花沢天氣，大雪提早出發。⚠️ 過横手後13號南下有下坡，用S檔/M檔引擎煞車。',
        lat: 39.42,
        lng: 141.08,
        type: 'stay'
      },
      {
        ...
        activity: '大正浪漫散策',
        notes: '接駁車進入，拍照',
        importantNotes: '🛣️ 347號有兩段：【安全段】銀山↔尾花沢(縣道188號)是平地OK。【危險段】尾花沢往東穿「鍋越峠」到鳴子是山區，積雪深、髮夾彎、易雪崩，絕對不要走！\n\n✅ 正確路線：銀山→縣道188號→尾花沢→國道13號【往北】→新庄→國道47號【往東】→鳴子溫泉。導航經由點設「新庄駅」。',
        lat: 38.57,
        lng: 140.53,
        type: 'sightseeing'
      },
